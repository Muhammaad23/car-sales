...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('title', 'price', 'discount_percent', 'is_active', 'count')  # Fields to display in the admin list
    ...
    fieldsets = (
        (None, {
            'fields': ('title', 'description', 'price', 'discount_percent', 'count', 'is_active')
        }),
        ('Image', {
            'fields': ('image',),
